import type { IKeyValueObject, ISaveableTypes } from "./Base/BaseTypes";
 ...
 */
export function clone<T extends ISaveableTypes>(obj: T, deepArray = false): T {
 ...
 */
export function mergeMap(map1: Map<unknown, unknown>, map2: Map<unknown, unknown>) {
 ...
 */
export function assignIfUndefined(obj: unknown, key: string, value: unknown) {
