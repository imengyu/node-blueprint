<template>
  <div>
    ...
    <div class="prop-item">
      <span>开始端口: </span>
      <div class="prop-item-editor text-warp">
    ...
    <div class="prop-item">
      <span>传递值: </span>
      <textarea class="prop-item-editor"  v-model="connector.valText">
      </textarea>
    </div>
  </div>
</template>
...
@Component
export default class ConnectorProp extends Vue {
  name = "ConnectorProp";

  @Prop({ default: null }) connector : ConnectorEditor;
