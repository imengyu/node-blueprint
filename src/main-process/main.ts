...
function recreateWindow(event : Event, submitErrReport : boolean) {
...
function initBasePath(callback : () => void) {
  ...
  if(fs.existsSync(appDir + '/dist/renderer.html')) appDir = appDir + '/dist/';
  else if(fs.existsSync(appDir + '/dist/development/renderer.html')) appDir = appDir + '/dist/development/';
  else if(fs.existsSync(appDir + '/resources/app/renderer.html')) appDir = appDir + '/resources/app/';
...
function initIpcs() {
  ...
  ipc.on('main-act-reload', (event) => {
    if(mainWindow && event.sender == mainWindow.webContents) 
      mainWindow.webContents.loadURL(getPagePath('renderer.html'))
  });
