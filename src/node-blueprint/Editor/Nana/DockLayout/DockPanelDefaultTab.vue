<template>
  <div 
    :id="'dock-tab-contol-uid-' + dockData.uid" 
    :style="{
...
import DockPanelDefaultCloseDark from './DockPanelDefaultCloseDark.svg';
import DockPanelDefaultCloseLight from './DockPanelDefaultCloseLight.svg';
...
export default defineComponent({
  ...
  setup() {
    ...
    return {
      dockHost,
      closeIcon: dockHost?.theme === 'dark' ? DockPanelDefaultCloseDark : DockPanelDefaultCloseLight,
    };
  },
  methods: {
